...
const Header = () => {
  ...
  <Container>
  <Navbar.Brand>Bike Junctions</Navbar.Brand>
      ...
      <Nav className=" me-auto fs-5">
       ...
       { user.email && 
          ...
          //Dropdown Button Here
              ...
              <Dropdown.Menu>
              {!admin &&<Dropdown.Item> <Link to="/payment" className='sub-dropdowns'>Payment</Link></Dropdown.Item>}
       ...
       {! user.email && <Link to="/signup"><button className="btn bg-primary ms-3">SignUp</button></Link>
        }
...
! user.email &&  <Link to="/login"> <button className="btn bg-primary border ms-xxl-5 ps-3" >Login</button> </Link>
        }
