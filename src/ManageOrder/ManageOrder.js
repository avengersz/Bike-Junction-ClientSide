...
import { MdDelete } from "react-icons/md";
  ...
  useEffect(() => {
    axios
      .get("https://gentle-oasis-77041.herokuapp.com/manageAllBookings")
      .then((result) => {
  ...
  const handleRemove = (id) => {
    ...
    axios
      .delete(
        `https://gentle-oasis-77041.herokuapp.com/deleteBooking/${id}`
      )
      .then((result) => {
...
const handleApprove = (id) => {
    ...
    if (proceed) {
      axios
        .put(
          `https://gentle-oasis-77041.herokuapp.com/approveBooking/${id}`
        )
        .then((result) => {
